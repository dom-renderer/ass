...
@section('content')
<form method="POST" action="{{ route('assets.store') }}" class="gift-submit-form" enctype="multipart/form-data"> @csrf
    <div class="row">
            <div class="col-12">
                ...
                <div class="fursa-form row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-12">
                                    <label class="form-label" for="locname"> Name <span class="text-danger">*</span> </label>
                                    <input name="name" type="text" class="form-control" id="locname" placeholder="Asset Name" value="{{ old('name') }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-12">
                                    ...
                                    <input name="ucode" type="text" class="form-control" id="ucode" placeholder="Unique Code" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-12">
                                    ...
                                    <input name="code" type="text" class="form-control" id="loccode" placeholder="Internal Code" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-12">
                                    ...
                                    <input name="po_date" type="date" class="form-control" id="po_date" placeholder="PO Date" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-12">
                                    ...
                                    <input name="warranty" type="number" min="0" step="1" max="1000" class="form-control" id="warranty" placeholder="Warranty (Months)" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-12">
                                    ...
                                    <input name="lifespan" type="number" min="0" step="1" max="1000" class="form-control" id="warranty" placeholder="Lifespan (Months)" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-row">
                                <div class="col-12">
                                    ...
                                    <select name="asset_status_id" id="asset_status_id" class="form-control" required>
                                        ...
                                        <option value="{{ $status->id }}" style="color: {{ $status->color }}; font-weight: bold;"> {{ $status->title }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-fursa-form-submit"><i class="bi bi-plus-circle"></i> Add </button>
                </div>
            </div>
        </div>
    </form>
