...
@section('content')
    <div class="p-4 rounded">
        <form action="{{ route('workflow-assignments.update', $assignment->id) }}" method="post" id="templateForm" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="start_from" id="start_from" class="form-control" value="{{ old('start_from', $assignment->start_from ? $assignment->start_from->format('Y/m/d H:i') : date('Y/m/d H:i')) }}" disabled>
                </div>
                ...
                <div class="col-md-12">
                    <input type="checkbox" style="height:20px;width:20px;" value="1" name="send_to_all_notification" id="send_to_all_notification" @if($assignment->send_to_all_notification == 1) checked @endif>
                ...
                <div class="col-md-12 mt-2">
                    <input type="checkbox" style="height:20px;width:20px;" value="1" name="on_going_project" id="on_going_project" @if($assignment->on_going_project == 1) checked @endif readonly>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h6 class="mb-0">Project Department</h6>
        ...
        $(document).ready(function () {
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                                            <h6 class="mb-0">Steps In This Department</h6>
                                                            <div>
            ...
            function validateForm() {
                ...
                for (const sectionId of sectionIds) {
                    ...
                    if (!section.steps || section.steps.length === 0) {
                        errors[`sections.${sectionIndex}.steps`] = [`Department "${section.name || 'Department ' + sectionIndex}" must have at least one step.`];
                    }
                    ...
                    if (section.steps) {
                        section.steps.forEach((step, stepIdx) => {
                            ...
                            if (!step.step_name || !step.step_name.trim()) {
                                errors[`${stepPrefix}.step_name`] = ['The step name field is required.'];
                            }
                            ...
                            if (step.is_entry_point && step.dependency_steps && step.dependency_steps.length > 0) {
                                errors[`${stepPrefix}.dependency_steps`] = [`Entry point "${step.step_name || 'Step ' + step.globalNumber}" cannot have parent dependencies.`];
                            }

                            if (step.dependency === 'SELECTED_COMPLETED' && (!step.dependency_steps || step.dependency_steps.length === 0) && !step.is_entry_point) {
                                errors[`${stepPrefix}.dependency_steps`] = ['Please select at least one dependent step or choose "No Dependency".'];
                            }
                        });
                    }
                }
            ...
            function makeFriendlyErrorMessage(key, message) {
                const friendlyNames = {
                    ...
                    'dependency_steps': 'Dependent Steps',
