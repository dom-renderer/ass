@php
  $headerAppName = !empty(optional($appConfig)->app_name) ? $appConfig->app_name : APP_NAME;
  $headerLogo = !empty(optional($appConfig)->logo_url)
    ? $appConfig->logo_url
    : (!empty(optional($appConfig)->logo_url) ? $appConfig->logo_url : asset('assets/logo.webp'));
@endphp
        ...
        <div class="row">
          <div class="col">
            ...
            <nav class="navbar navbar-expand">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item header-title"><a href="#" class="nav-link"> {{ $headerAppName }} </a></li>
              </ul>
            </nav>
            <!-- /.navbar -->
          </div>
          <div class="col">
            <div class="premium-merchant flex-div">
              <img src="{{ $headerLogo }}" alt="{{ $headerAppName }}" style="height: 60px;width: 60px;border-radius: 50%;">
            </div>
          </div>
          <div class="col">
