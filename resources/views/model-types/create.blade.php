...
<div class="px-6 pt-6 pb-10">
    <form method="POST" action="{{ route('model-types.store') }}" class="max-w-3xl mx-auto">
        @csrf

        <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Add Model Type</h2>
                <p class="text-sm text-gray-400 mt-0.5">Create a new Model Type entry in the system.</p>
            </div>
