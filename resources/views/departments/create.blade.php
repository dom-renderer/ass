...
<div class="px-6 pt-6 pb-10">
    <form method="POST" action="{{ route('departments.store') }}" class="max-w-3xl mx-auto">
        @csrf

        <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Add Department</h2>
                <p class="text-sm text-gray-400 mt-0.5">Create a new Department entry in the system.</p>
            </div>
            ...
            <div class="p-5">
                <div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="description" id="description" class="form-textarea" placeholder="Enter a brief description">{{ old('description') }}</textarea>
                    </div>
            </div>
        </div>
    </form>
