                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <span class="rounded-circle bg-light d-inline-flex align-items-center justify-content-center" style="width:64px;height:64px;">
                                <img src="{{ $ticket->store->pi }}" style="width:64px;height:64px;objec-fit:contain;border-radius:50%;">
                            </span>
                            @endif
                            <div>
                                <div class="fw-semibold">{{ $ticket->store->name ?? '' }} </div>
                                <div class="text-muted small">{{ $ticket->store->modeltype->name ?? '' }} | {{ $ticket->store->storetype->name ?? '' }}</div>
                            </div>
                        </div>
                        <div class="row g-2 small">
                            <div class="col-4">Unique Code</div>
                            <div class="col-8 text-truncate">{{ $ticket->store->ucode ?? 'N/A' }}</div>
                            <div class="col-4">Internal Code</div>
