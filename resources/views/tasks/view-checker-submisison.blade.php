    ...
    <div class="bg-light p-4 rounded">
        ...
        <table class="table table-bordered table-stripped">
            ...
            <tbody>
                ...
                @if(isset($checkerData->signature) && is_file(storage_path("app/public/checker-signatures/{$checkerData->signature}")))
                <tr>
                    <td>
                        <strong>
                            Signature  
                    ...
                    <td>
                        <a href="{{ url('storage/checker-signatures/' . $checkerData->signature) }}" target="_blank">
                            <img src="{{ url('storage/checker-signatures/' . $checkerData->signature) }}" style="height: 130px;width:130px;">
                        </a>
                    </td>
                </tr>
                @endif
                ...
                @forelse ($groupedData as $className => $fields)
                    <tr>
                        @php
                            ...
                            $thisField = collect($fields)->where('type', 'radio-group')->first();
