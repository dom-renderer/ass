...
@section('content')
    <div class="p-4 rounded">
        <form action="{{ route('workflow-templates.store') }}" method="post" id="templateForm" novalidate>
            @csrf
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-12">
                    <input type="checkbox" style="height:20px;width:20px;" value="1" name="send_to_all_notification" id="send_to_all_notification">
        ...
        $(document).ready(function () {
                                    ...
                                    <div class="d-flex align-items-center p-3">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-1">
                                                ...
                                                <span class="section-number">Department ${sectionNumber}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card border-0 shadow-sm step-item">
                                        <div class="card-header bg-gradient-primary text-white d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center">
                                                <span class="step-number badge bg-white text-primary me-2">T${step.globalNumber}</span>
                                                <h6 class="mb-0">Task ${step.globalNumber}</h6>
                                                            ...
                                                            <div class="accordion-body row">
                                                                ...
                                                                <div class="col-md-6 mt-2">
                                                                    ...
                                                                    <select class="form-select select2" data-whichselect="maker-completion-email-list" id="step-${step.id}-maker_completion_email_notification" name="sections[${section.id}][steps][${step.id}][maker_completion_email_notification]" >
                                                                        ${step.maker_completion_email_notification ? `<option value="${step.maker_completion_email_notification}" selected>${step.maker_completion_email_name || 'Selected Template'}</option>` : ''}
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6 mt-2">
                                                                    ...
                                                                    <select class="form-select select2" data-whichselect="maker-completion-push-list" id="step-${step.id}-maker_completion_push_notification" name="sections[${section.id}][steps][${step.id}][maker_completion_push_notification]" >
                                                                        ${step.maker_completion_push_notification ? `<option value="${step.maker_completion_push_notification}" selected>${step.maker_completion_push_name || 'Selected Template'}</option>` : ''}
                                                                    </select>
                                                                </div>
                                                                <hr class="mt-4 mb-4">
                                                                ...
                                                                <div class="col-md-6 mt-2">
                                                                    ...
                                                                    <select class="form-select select2" data-whichselect="maker-dependency-email-list" id="step-${step.id}-maker_dependency_email_notification" name="sections[${section.id}][steps][${step.id}][maker_dependency_email_notification]" >
                                                                        ${step.maker_dependency_email_notification ? `<option value="${step.maker_dependency_email_notification}" selected>${step.maker_dependency_email_name || 'Selected Template'}</option>` : ''}
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6 mt-2">
                                                                    <label class="form-label fw-semibold">Push Notification Template</label>
                                                                    <select class="form-select select2" data-whichselect="maker-dependency-push-list" id="step-${step.id}-maker_dependency_push_notification" name="sections[${section.id}][steps][${step.id}][maker_dependency_push_notification]" >
                                                                        ${step.maker_dependency_push_notification ? `<option value="${step.maker_dependency_push_notification}" selected>${step.maker_dependency_push_name || 'Selected Template'}</option>` : ''}
                                                                    </select>
                                                                </div>
                                                                <hr class="mt-4 mb-4">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select class="form-select select2" data-whichselect="escalation-maker-list" id="step-${step.id}-maker_escalation_user_ids" name="sections[${section.id}][steps][${step.id}][maker_escalation_user_ids][]" multiple>
                                                                        ${(step.maker_escalation_user_ids && Array.isArray(step.maker_escalation_user_ids)) ? step.maker_escalation_user_ids.map((userId, index) => `<option value="${userId}" selected>${(step.maker_escalation_user_names && step.maker_escalation_user_names[index]) || 'Selected User'}</option>`).join('') : (step.maker_escalation_user_id ? `<option value="${step.maker_escalation_user_id}" selected>${step.maker_escalation_user_name || 'Selected User'}</option>` : '')}
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6 mt-2">
                                                                    <label class="form-label fw-semibold">Email Notification Template</label>
                                                                    <select class="form-select select2" data-whichselect="maker-email-list" id="step-${step.id}-maker_escalation_email_notification" name="sections[${section.id}][steps][${step.id}][maker_escalation_email_notification]" >
                                                                ...
                                                                <div class="col-md-6 mt-2">
                                                                    <label class="form-label fw-semibold">Push Notification Template</label>
                                                                    <select class="form-select select2" data-whichselect="maker-push-list" id="step-${step.id}-maker_escalation_push_notification" name="sections[${section.id}][steps][${step.id}][maker_escalation_push_notification]" >
                                                            ...
                                                            <div class="accordion-body row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select class="form-select select2" data-whichselect="escalation-checker-list" id="step-${step.id}-checker_escalation_user_ids" name="sections[${section.id}][steps][${step.id}][checker_escalation_user_ids][]" multiple>
                                                                        ${(step.checker_escalation_user_ids && Array.isArray(step.checker_escalation_user_ids)) ? step.checker_escalation_user_ids.map((userId, index) => `<option value="${userId}" selected>${(step.checker_escalation_user_names && step.checker_escalation_user_names[index]) || 'Selected User'}</option>`).join('') : (step.checker_escalation_user_id ? `<option value="${step.checker_escalation_user_id}" selected>${step.checker_escalation_user_name || 'Selected User'}</option>` : '')}
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="form-label fw-semibold">Escalation After</label>
                                                                ...
                                                                <div class="col-md-6 mt-2">
                                                                    <label class="form-label fw-semibold">Email Notification Template</label>
                                                                    <select class="form-select select2" data-whichselect="checker-email-list" id="step-${step.id}-checker_escalation_email_notification" name="sections[${section.id}][steps][${step.id}][checker_escalation_email_notification]" >
                                                                ...
                                                                <div class="col-md-6 mt-2">
                                                                    <label class="form-label fw-semibold">Push Notification Template</label>
                                                                    <select class="form-select select2" data-whichselect="checker-push-list" id="step-${step.id}-checker_escalation_push_notification" name="sections[${section.id}][steps][${step.id}][checker_escalation_push_notification]" >
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-hint">
                                            ...
                                            Use section-oriented names that clearly indicate the department's purpose
                                        </div>
                                    </div>
            ...
            function initializeStepEventHandlers(sectionId) {
                ...
                $(document).on('change', '.dependency-select', function () {
                    ...
                    const depStepsSelect = container.find('.dep-steps');
                    
                    if ($(this).val() === 'SELECTED_COMPLETED') {
                        container.removeClass('d-none');
                        // Initialize Select2 if not already initialized
                        if (depStepsSelect.length > 0 && !depStepsSelect.data('select2')) {
                            depStepsSelect.select2({
                                width: '100%',
                                theme: 'classic',
                        ...
                        if (depStepsSelect.length > 0) {
                            if (depStepsSelect.data('select2')) {
                                depStepsSelect.val(null).trigger('change');
                            } else {
                                depStepsSelect.val(null);
                            }
                        }
                    }
            ...
            function initializeSelect2(scope) {
                if (scope) {
                    ...
                    // Initialize Select2 for dependency_steps dropdowns first
                    // This ensures they work properly with select2('val')
                    scope.find('select.dep-steps').each(function () {
                ...
                if (validateForm()) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            Swal.fire('Success', 'Project template saved succesfully', 'success');
