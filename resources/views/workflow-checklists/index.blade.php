...
@section('content')
    ...
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead">
            {{ $page_description }}
            @if (auth()->user()->can('workflow-checklists.create'))
                <a href="{{ route('workflow-checklists.create') }}" class="btn btn-primary btn-sm float-end me-2">Add Checklists Template</a>
            @endif
        </div>
