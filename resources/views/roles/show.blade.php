    ...
    <div class="">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('roles.edit', $role->id) }}" class="inline-flex items-center gap-2 px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm text-decoration-none">
