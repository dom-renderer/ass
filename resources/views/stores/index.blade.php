...
@section('content')
    ...
    <div class="row">
        <form action="{{ route('stores.index') }}" method="GET" class="col-lg-12">
            <div class="row">
                <div class="col-2 col-xl-4 col-lg-4">
                ...
                <div class="col-2 col-xl-4 col-lg-4">
                    <label for="filter_ucode" class="form-label"> Unique Code </label>
            ...
            <div class="row export-button">
                 <div class="col-6 col-xl-6 col-lg-6">
                    ...
                    <a href="{{ route('stores.index') }}" class="btn btn-danger  @if(empty($stateFilter) && empty($cityFilter) && empty($domFilter) && empty(request('filter_location')) && empty(request('filter_name')) && empty(request('filter_ucode')) ) d-none @endif"> Clear </a>
                </div>
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-12">
                                        ...
                                        <input name="ucode" type="text" class="form-control" id="uniquecode" placeholder="Unique Code" required ></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-12">
                                        ...
                                        <input name="number_of_tables" id="number_of_tables" type="number" min="0" max="9999" class="form-control"
                        ...
                        <div class="col-lg-12 col-xl-4">
                            <div class="listing-box">
                                ...
                                <div class="wrapper">
                                    ...
                                    <p class="description">
                                        <a target="_blank" href="{{ isset($branch->scan_links['qr_code_label']) ? $branch->scan_links['qr_code_label'] : '' }}">
                                            {{ $branch->ucode }}
                                        </a>
                                    </p>
                                </div>
                                ...
                                <div class="wrapper">
                                    ...
                                    <p class="description">
                                        <a target="_blank" href="{{ isset($branch->scan_links['barcode_label']) ? $branch->scan_links['barcode_label'] : '' }}">
                                            {{ $branch->ucode }}
                                        </a>
                                    </p>
                                </div>
                                ...
                                <div class="">
                                    ...
                                    @can('store_qr_codes.view')
                                        <a class="d-block mb-2" href="{{ route('locations.qr-codes.index', $branch->id) }}"><button type="button" class="btn btn-primary w-100"> QR Codes </button></a>
                                    @endcan
                                    @can('store_menu.manage')
                                        <a class="d-block mb-2" href="{{ route('locations.menu-assignment.index', $branch->id) }}"><button type="button" style="background: palegreen;" class="btn w-100"> Assign Menu </button></a>
                                    @endcan
                                    ...
                                    <button style="margin-right:20px;" type="submit" class="btn btn-danger w-100 mt-2 deleteGroup">Delete</button>
