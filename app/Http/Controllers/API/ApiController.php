...
class ApiController extends \App\Http\Controllers\Controller
{
    ...
    public function assets(Request $request) {
        return response()->json(['success' => Store::withoutGlobalScope('os')->ass()->when(!empty($request->store_id), function ($builder) {
            $builder->where('location', request('store_id'));
        })->with(['dom', 'storetype', 'modeltype', 'asassets', 'store'])->orderBy('name', 'ASC')->get()]);
    }
