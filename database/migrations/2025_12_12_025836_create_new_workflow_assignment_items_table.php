...
class CreateNewWorkflowAssignmentItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('new_workflow_assignment_items', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('new_workflow_assignment_items');
    }
}
